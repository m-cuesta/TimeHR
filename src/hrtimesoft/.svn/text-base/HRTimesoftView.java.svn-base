...
public class HRTimesoftView extends FrameView implements WindowListener {
    ...
    private Usuario usr;
    private static String versionInfo = "<html>Versión " + HRTimesoftApp.VERSION + " - TC" + timesoft.Constantes.VERSION + "&nbsp;&nbsp;&nbsp;</html>";
    ...
    public final void myInit() throws NoConnectionException, BDException {
        ...
        if ( tm != null )
        {
            tm.setStatus(statusMessageLabel);
            tm.showMessage("Archivo de configuración cargado");
        }
        else
            statusMessageLabel.setText("Sin archivo de configuración. Utilice la opción Generar Archivo.");
    ...
    private void initComponents() {
        ...
        logMarcsForm.add(botonExportarExcel, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 420, 120, -1));
        ...
        jButton36.setAction(actionMap.get("paintLogMarcsForm")); // NOI18N
        jButton36.setText(resourceMap.getString("jButton36.text")); // NOI18N
        jButton36.setName("jButton36"); // NOI18N
        marcacionesMenu.add(jButton36, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, 220, -1));
        ...
        novedadesPaqueteForm.add(jButton21, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 460, -1, -1));
    ...
    public String getConexionesString() {
        try
        {
            ...
            sb.append("Time HR - Version " + timesoft.Constantes.VERSION );
            sb.append("\n");
            sb.append("Fecha de lanzamiento: " + timesoft.Constantes.VERSION_FECHA );
            sb.append("\n");

            Properties tmProps = tm.getProps();
            sb.append("SIBO: " + tmProps.getProperty("url"));
            sb.append("\n");
            sb.append("ASHOST: " + tmProps.getProperty("jco.client.ashost"));
            sb.append("\n");
            sb.append("CLIENT: " + tmProps.getProperty("jco.client.client"));
            sb.append("\n");
            sb.append("SYSNR: " + tmProps.getProperty("jco.client.sysnr") );
            sb.append("\n");
            return sb.toString();
        }
        catch ( Exception ex )
        {
            return "Sin archivo de configuración";
        }
    }
